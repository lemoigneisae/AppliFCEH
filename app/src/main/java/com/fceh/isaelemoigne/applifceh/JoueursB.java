...
public class JoueursB extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        joueur1 = new Joueur("Hugo Delaunay","Milieu excentré", 11);
        joueur2 = new Joueur("Charles Runser","Attaquant", 9);
        joueur3 = new Joueur("Maxime Bouyer","Milieu défensif", 6);
        joueur4 = new Joueur("Benjamin Leclerc","Défenseur central", 4);
        ...
        adapter = new MonAdaptateurDeListe(JoueursB.this, listeJoueurs);
        ...
        list.setOnItemClickListener(
                new AdapterView.OnItemClickListener(){
                    public void onItemClick(AdapterView<?> parent, View view, int position, long id){
                        ...
                        Intent retour = new Intent(JoueursB.this, AjoutJoueurs.class);
