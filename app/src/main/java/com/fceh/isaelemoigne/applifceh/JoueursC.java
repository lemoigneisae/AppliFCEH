...
public class JoueursC extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        joueur1 = new Joueur("Adrien Léonard","Milieu excentré", 7);
        joueur2 = new Joueur("Matthieu Negroni","Milieu offensif", 10);
        joueur3 = new Joueur("Clément Melet","Milieu excentré", 11);
        joueur4 = new Joueur("Isaë Le Moigne","Attaquant", 9);
        ...
        adapter = new MonAdaptateurDeListe(JoueursC.this, listeJoueurs);
        ...
        list.setOnItemClickListener(
                new AdapterView.OnItemClickListener(){
                    public void onItemClick(AdapterView<?> parent, View view, int position, long id){
                        ...
                        Intent retour = new Intent(JoueursC.this, AjoutJoueurs.class);
